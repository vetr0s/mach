...
//
// The engine holds no mutable global state: everything lives in the Engine /
// Renderer / Arena structs the caller owns and passes by pointer. That is what
...
// Arena allocator implementation (MACH_IMPLEMENTATION).
...
// Image implementation using stb_image (MACH_IMPLEMENTATION).
...
// Input snapshot implementation (MACH_IMPLEMENTATION).
